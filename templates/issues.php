        ...
        <table class="repo-table striped wp-list-table widefat issues" role="presentation">
            ...
            <?php foreach( $issues as $oneIssue ) { ?>
                <tr class="one-issue">
                    ...
                    <td><a href="<?php esc_attr_e( $oneIssue->repoInfo->repoUrl ); ?>"><?php esc_html_e( $oneIssue->repoInfo->fullName ); ?></a></td>
                    <td><img src="<?php esc_attr_e( $oneIssue->postedBy->avatarUrl ); ?>"/><span class="name"><a href="<?php esc_attr_e( $oneIssue->postedBy->userUrl ); ?>"><?php echo $oneIssue->postedBy->user; ?></a></span></td>
                    <td><a href="<?php esc_attr_e( $oneIssue->url ); ?>"><?php echo $oneIssue->title; ?></a></td>
